      ...
      <div className="todo-list">
        ...
        <div className='concealer'>
          ...
          <div className="todo-completed">
            ...
            <div className='todo'><span>Todo Test</span><input type='checkbox' checked /><label for='checkbox'></label></div>
            <div className='todo'><span>Todo Test</span><input type='checkbox' checked /><label for='checkbox'></label></div>
            <div className='todo'><span>Todo Test</span><input type='checkbox' checked /><label for='checkbox'></label></div>
            <div className='todo'><span>Todo with too much text for it's own good. Lorem ipsum.</span><input type='checkbox' checked /><label for='checkbox'></label></div>
          </div>
        </div>
      </div>
